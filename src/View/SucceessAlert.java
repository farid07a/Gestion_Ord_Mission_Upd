...
import Controller.AWTUtilities;
 ...
 * @author horizon
 */
public class SucceessAlert extends javax.swing.JDialog {
Home home;
     Timer timer = null;
    TimerTask task;
    int i = 32;
    
    public SucceessAlert(Home h) {
        super(h);
        initComponents();
        home=h;
...
public void Position(int y){
   ...
   this.setLocation(520, y-(this.getHeight()));
  ...
  private void Trasparent(float trasp) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/USsuccess.png"))); // NOI18N
        jLabel1.setOpaque(true);

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("تم اضافة المهمـة بنجاح");
 ...
 task=new TimerTask() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SucceessAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SucceessAlert dialog = new SucceessAlert(null);
